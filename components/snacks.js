...
export function DangerSnack({ message }) {
  function hideSnack() {
  ...
  return (
    <div
      id="danger"
      className="absolute transition-all top-4 toast-toggle p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
      role="alert"
    >
      <svg
        aria-hidden="true"
...
export function SuccessSnack({ message }) {
  ...
  return (
    <div
      id="success"
      className="absolute top-4 toast-toggle p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
      role="alert"
    >
      <svg
        aria-hidden="true"
...
export function DangerToast({ message }) {
  ...
  return (
    <div id="toast-danger" className="absolute top-4 toast-toggle items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
